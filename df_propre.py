...
class Recup_Donneees_VP:
    ...
    def df_propre_final_fr(self):
        ...
        df_ccicp_geoloc_propre['Code Postal'] = df_ccicp_geoloc_propre['Code Postal'].str[:5]
        df_ccicp_geoloc_propre['Code Postal'] = df_ccicp_geoloc_propre['Code Postal'].astype(str)
        ...
        df_merged_pref2 = self.merge_dfs(df_doublon, df_ccicp_geoloc_propre,0)
        ...
        parc_vp_propre_geoloc = pd.merge(df_final, df_ccicp_geoloc_propre[['Code INSEE','geo_point_2d','geo_shape','ID Geofla']], left_on='code_commune_insee_residence', right_on='Code INSEE', how='left')
